...
function AlertDialogAction({
  ...
  return (
    <AlertDialogPrimitive.Action
      className={cn(buttonVariants(), "h-10 sm:h-9 text-xs font-bold rounded-xl cursor-pointer shadow-xs", className)}
      {...props}
    />
  )
}
...
function AlertDialogCancel({
  ...
  return (
    <AlertDialogPrimitive.Cancel
      className={cn(buttonVariants({ variant: "outline" }), "h-10 sm:h-9 text-xs font-semibold rounded-xl cursor-pointer", className)}
      {...props}
    />
  )
}
